...
import com.user.pojo.vo.UserXVo;
...
public class UserController {
    ...
    public Object deleteUser(@NotNull @RequestParam(value = "id") String id) {
    ...
    public Object updateUser(@NotNull @RequestParam(value = "id") String id, @NotNull @RequestParam("name") String name) {
        UserVo userVo = new UserVo();
        userVo.setLoginName(id);
    ...
    public Object selectUser(@Valid @RequestBody UserXVo userXVo) {
        return userService.select(userXVo);
    }
    ...
    @ResponseBody
    @ApiOperation(value = "我的反馈", response = Result.class)
    public Object myFeedback(@NotNull @RequestParam(value = "id") String id) {
        return feedbackService.selectMy(id);
    }
